...
<div class="w-full px-4 md:px-0 md:w-3/4 lg:w-1/2 xl:w-1/3 2xl:w-1/4">
    ...
    <div class="mt-10 bg-gray-800 p-4 rounded-md shadow-lg flex flex-col items-center max-w-full mb-10">
        {#if form?.r34}
